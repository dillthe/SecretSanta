...
public interface CoupleRepository extends JpaRepository<CoupleEntity, Integer> {
    Optional<CoupleEntity> findByParticipant1IdAndParticipant2Id(Integer participant1Id, Integer participant2Id);
    Optional<CoupleEntity> findByParticipant2IdAndParticipant1Id(Integer participant2Id, Integer participant1Id);
